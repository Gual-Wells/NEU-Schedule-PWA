...
assert(D.courses.length === 13, 'expected 12 regular courses plus one temporary test course');
...
assert(D.courses[12].date === '2026-09-26' && D.courses[12].startTime === '15:50' && D.courses[12].endTime === '16:35', 'temporary test course drifted');
assert(JSON.stringify(D.gym.overrides['2026-09-26']) === JSON.stringify([['15:50','20:40']]), 'temporary gym override drifted');
